...
const frames = [
  ...
  { id: 4, name: "Minimalist Matte Black", imageUrl: "/img/images4.png" },
  { id: 5, name: "Natural Barnwood", imageUrl: "/img/images5.png" },
  ...
  { id: 9, name: "Elegant Ornate Silver", imageUrl: "/img/images9.png" },
  { id: 10, name: "Modern Gallery White", imageUrl: "/img/images10.png" },
